        ...
        <div class="row">
            ...
            <div class="col-6">
                <div class="form__group">
                    ...
                    <Field :class="{ 'disabled': isLoaded }" type="text" id="f__bank_name" name="bank_name"
                        :value="formData?.bank_name" />
                    <ErrorMessage name="bank_name" />
                </div>
                <div class="form__group">
                    <label for="f__bank_branch">Bank branch name</label>
                    <Field :class="{ 'disabled': isLoaded }" type="text" id="f__bank_branch" name="bank_branch"
                        :value="formData?.bank_branch" />
                    <ErrorMessage name="bank_branch" />
                </div>
                <div class="form__group">
                    <label for="f__bank_account_holder_name">Account holder name</label>
                    <Field :class="{ 'disabled': isLoaded }" type="text" id="f__bank_account_holder_name"
            ...
            <div class="col-6">
                <div class="form__group">
                    ...
                    <Field :class="{ 'disabled': isLoaded }" type="text" id="f__bank_account_number"
                        name="bank_account_number" :value="formData?.bank_account_number" />
                    <ErrorMessage name="bank_account_number" />
                </div>
                <div class="form__group">
                    <label for="f__bank_swift_code">Account number</label>
                    <Field :class="{ 'disabled': isLoaded }" type="text" id="f__bank_swift_code" name="bank_swift_code"
                    ...
                    <div class="col-6">
                        <fieldset>
                            ...
                            <div class="form__group">
                                ...
                                <Field :class="{ 'disabled': isLoaded }" type="text" id="f__from_name" name="from_name"
                                    :value="formData?.from_name" />
                                <ErrorMessage name="from_name" title="Name" />
                            </div>
                            <div class="form__group">
                                <label for="f__from_email">Email</label>
                                <Field :class="{ 'disabled': isLoaded }" type="email" id="f__from_email"
                                    name="from_email" title="Email" :value="formData?.from_email" />
                                <ErrorMessage name="from_email" />
                            </div>
                            <div class="form__group">
                                <label for="f__from_address">Address</label>
                                <Field :class="{ 'disabled': isLoaded }" type="text" id="f__from_address"
                                    name="from_address" :value="formData?.from_address" />
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form__group">
                                            ...
                                            <Field :class="{ 'disabled': isLoaded }" type="text" id="f__from_city"
                                                name="from_city" :value="formData?.from_city" />
                                    ...
                                    <div class="col-6">
                                        <div class="form__group">
                                            ...
                                            <Field :class="{ 'disabled': isLoaded }" type="text" id="f__from_state"
                                                name="from_state" :value="formData?.from_state" />
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form__group">
                                            ...
                                            <Field :class="{ 'disabled': isLoaded }" as="select" id="f__from_country"
                                    ...
                                    <div class="col-6">
                                        <div class="form__group">
                                            ...
                                            <Field :class="{ 'disabled': isLoaded }" type="text" id="f__from_post_code"
                    ...
                    <div class="col-6">
                        <fieldset>
                            ...
                            <div class="form__group">
                                ...
                                <Field :class="{ 'disabled': isLoaded }" type="text" id="f__to_name" name="to_name"
                                    :value="formData?.to_name" />
                                <ErrorMessage name="to_name" />
                            </div>
                            <div class="form__group">
                                <label for="f__to_email">Email</label>
                                <Field :class="{ 'disabled': isLoaded }" type="email" id="f__to_email" name="to_email"
                                    :value="formData?.to_email" />
                                <ErrorMessage name="to_email" />
                            </div>
                            <div class="form__group">
                                <label for="f__to_address">Address</label>
                                <Field :class="{ 'disabled': isLoaded }" type="text" id="f__to_address"
                                    name="to_address" :value="formData?.to_address" />
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form__group">
                                            ...
                                            <Field :class="{ 'disabled': isLoaded }" type="text" id="f__to_city"
                                                name="to_city" :value="formData?.to_city" />
                                    ...
                                    <div class="col-6">
                                        <div class="form__group">
                                            ...
                                            <Field :class="{ 'disabled': isLoaded }" type="text" id="f__to_state"
                                                name="to_state" :value="formData?.to_state" />
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form__group">
                                            ...
                                            <Field :class="{ 'disabled': isLoaded }" as="select" id="f__to_country"
                                                name="to_country" :value="formData?.to_country">
                                                <option value="">Select a country</option>
                                                <option v-for="country in countries" :value="country.code">{{
                                                    country.name }}
                                                </option>
                                    ...
                                    <div class="col-6">
                                        <div class="form__group">
                                            ...
                                            <Field :class="{ 'disabled': isLoaded }" type="text" id="f__to_post_code"
            ...
            <div class="col-4">
                ...
                <div class="form__group">
                    ...
                    <Field :class="{ 'disabled': isLoaded }" type="text" id="f__invoice_no" name="invoice_no"
                        :value="invoiceNo" />
